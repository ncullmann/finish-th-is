-LRB- CNN -RRB- -- Al Qaeda leader Osama bin Laden will address the West in a new message , according to a banner ad from the group 's production wing posted on Islamist Web sites known to carry messages from al Qaeda and bin Laden .
