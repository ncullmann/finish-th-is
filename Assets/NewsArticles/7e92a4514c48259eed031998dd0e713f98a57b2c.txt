-LRB- CNN -RRB- A bill that would allow Utah to use firing squads to execute some death-row prisoners passed in the state Senate on Tuesday .
...
`` Our statute is clear that lethal injection is the method by which -LRB- an execution -RRB- will happen . We have no intent to change that , '' he said .

The law would give the state the option to use a five-member squad in cases where the drugs necessary for lethal injection are n't available 30 days before the date set for the execution .
