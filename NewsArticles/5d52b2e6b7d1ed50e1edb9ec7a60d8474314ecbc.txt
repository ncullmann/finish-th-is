Minneapolis , Minnesota -LRB- CNN -RRB- -- The Gulf Coast oil disaster .
...
`` All these large scale critical systems that we take for granted ... how do we prevent systemic failure in them , '' he said . `` If a disturbance occurs in one place , how do we identify precursors to disturbances before -LSB- disaster -RSB- happens ? ''
